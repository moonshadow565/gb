...
struct gb::MCB1 final : gb::BUS {
    ...
    constexpr byte_t read_byte(word_t address) noexcept override {
    ...
    constexpr void write_byte(word_t address, byte_t value) noexcept override {
        switch((address >> 12) & 0xF) {
        case 0x0:
        case 0x1:
    ...
    constexpr virtual void waste() noexcept override {}
};
